...
import View.Administrador.Dados.DialogDadosDisciplina;
...
public class DialogDisciplina extends javax.swing.JDialog {
    ...
    Disciplina turma = new Disciplina();
    ...
    private void initComponents() {
        ...
        pPrincipal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 5));
        ...
        lTitulo2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icon-discplina.png"))); // NOI18N
        lTitulo2.setText("Disciplinas");
        ...
        bCadastrarPrincipal1.setText("Cadastrar Disciplina");
        ...
        cbPesquisarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione um item", "Nome", "Área de Ensino" }));
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificador", "Nome", "Área de Ensino", "Professor"
            }
        ) {
            ...
            .addGroup(pPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(pPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pPrincipalLayout.createSequentialGroup()
                        .addGroup(pPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pPrincipalLayout.createSequentialGroup()
                                .addComponent(bCadastrarPrincipal1, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addGroup(pPrincipalLayout.createSequentialGroup()
                                ...
                                .addGroup(pPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(bAtualizar, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(pPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(bPesquisar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(cbPesquisarPor, javax.swing.GroupLayout.Alignment.LEADING, 0, 130, Short.MAX_VALUE)))))
        ...
        pPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(pPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(bCadastrarPrincipal1, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                    .addComponent(bExcluirPrincipal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 784, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void bCadastrarPrincipal1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCadastrarPrincipal1ActionPerformed
        DialogDadosDisciplina telaDados = new DialogDadosDisciplina(null, true);
        telaDados.setAcao(1);
        
        telaDados.setTurmas(controleTurma.listarTodas());
        telaDados.setProfessores(controleProf.listarTodas());
    ...
    private void bPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPesquisarActionPerformed
        if (cbPesquisarPor.getSelectedIndex() == 0 || txtPesquisa.getText().equals("")) {
            ...
            } else if (cbPesquisarPor.getSelectedIndex() == 2) {
                if (txtPesquisa.getText().matches("[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]*")) {
                    atualizarTabelaPorArea();
                } else {
                    JOptionPane.showMessageDialog(this, "Por favor, ao buscar pela Área coloque apenas letras");
                }
            }
        }
    ...
    private void bVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVisualizarActionPerformed
        ...
        if (linha == -1) {
            ...
            JOptionPane.showMessageDialog(this, "Selecione uma disciplina da tabela para visualizar!");

        } else {
            disciplinaSelecionada = listaDisciplina.get(linha);
            telaDados.setAcao(3);
            
            telaDados.setTurmas(controleTurma.listarTodas());
            telaDados.setProfessores(controleProf.listarTodas());
            telaDados.setId(disciplinaSelecionada.getIdDisciplina());
            telaDados.setNome(disciplinaSelecionada.getNome());
            telaDados.setArea(disciplinaSelecionada.getArea());
            telaDados.setTurma(disciplinaSelecionada.getTurma());
            telaDados.setProfessor(disciplinaSelecionada.getProntuario_prof());
    ...
    private void bEditarPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarPrincipalActionPerformed
        ...
        if (linha == -1) {
            ...
            disciplinaSelecionada.setIdDisciplina(telaDados.getId());
            disciplinaSelecionada.setNome(telaDados.getNome());
            disciplinaSelecionada.setArea(telaDados.getArea());
            disciplinaSelecionada.setTurma(telaDados.getTurma());
            disciplinaSelecionada.setProntuario_prof(telaDados.getProfessor());
    ...
    private void bExcluirPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExcluirPrincipalActionPerformed
        ...
        if (linha == -1) {
            ...
            disciplinaSelecionada = listaDisciplina.get(linha);
            if(JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir esta disciplina?\n" + disciplinaSelecionada.getNome(), "Confirmar remoção",0)==0){
                controle.remover(disciplinaSelecionada);
    ...
    public void atualizarTabela()
    {
        ...
        listaDisciplina.addAll(controle.listarTodas());
        ...
        {
            modelo.addRow(new Object[]{d.getIdDisciplina(), d.getNome(), d.getArea(), d.getProntuario_prof()});
        }
    }
    ...
    public void atualizarTabelaPorNome()
    {
        ...
        listaDisciplina.addAll(controle.listarPorNome(txtPesquisa.getText()));
    ...
    public void atualizarTabelaPorArea()
    {
        DefaultTableModel modelo = (DefaultTableModel) tabela.getModel();
        
        listaDisciplina.clear();
        
        listaDisciplina.addAll(controle.listarPorArea(txtPesquisa.getText()));
    ...
    public void atualizarTabelaPorId()
    {
        DefaultTableModel modelo = (DefaultTableModel) tabela.getModel();
        
        listaDisciplina.clear();
        
        listaDisciplina.addAll(controle.listarPorId(Integer.valueOf(txtPesquisa.getText())));
